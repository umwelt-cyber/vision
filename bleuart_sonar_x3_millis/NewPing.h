...
//EDIT to one_pin_enagled to false, running two pins. HC-SR04 does not support one pin(i think).Jacob.
...
//EDIT echo_timer_freq to lower value for lower latency between each cycle.Jacob.
#define ECHO_TIMER_FREQ 10      // Frequency to check for a ping echo (every 24uS is about 0.4cm accuracy). Default=24
...
#define PING_TIMER_OVERHEAD 13  // Ping timer overhead in microseconds (uS). Default=13
 ...
 //NOTE under certain circumstances it may be good to allow this to be set from input pased on humidity, atm, temp..ect for more accurate travel speeds through air.Jacob.
